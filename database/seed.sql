...
-- -------------------------------------------------------------------------------------
-- Currencies. ILS is the base (reporting) currency; JOD carries three minor units.
-- -------------------------------------------------------------------------------------
...
-- Rates are "base-currency units per one unit of this currency", so ILS is exactly 1.
INSERT INTO currency_exchange_rates (currency_code, rate_to_base, updated_at)
VALUES
    ('ILS', 1.000000, '2026-01-05 08:00:00.000000'),
    ('USD', 3.650000, '2026-01-05 08:00:00.000000'),
    ('EUR', 3.940000, '2026-01-05 08:00:00.000000'),
    ('JOD', 5.150000, '2026-01-05 08:00:00.000000'),
    ('GBP', 4.620000, '2026-01-05 08:00:00.000000');
...
VALUES
    (1, 'ILS', 'ILS', 'EXCLUSIVE', 0.1600, 'INV', '2026-01-05 08:00:00.000000');
...
VALUES
    (1,  'LAP-1401', '7290001000014', 'Business Laptop 14"',        4299.0000, 'ILS', 0.1600, 1, '2026-01-07 10:00:00.000000', '2026-01-07 10:00:00.000000'),
    (2,  'MSE-2201', '7290001000021', 'Wireless Mouse',               89.9000, 'ILS', 0.1600, 1, '2026-01-07 10:01:00.000000', '2026-01-07 10:01:00.000000'),
    (3,  'KBD-3310', '7290001000038', 'Mechanical Keyboard',         349.0000, 'ILS', 0.1600, 1, '2026-01-07 10:02:00.000000', '2026-01-07 10:02:00.000000'),
    (4,  'MON-2704', '7290001000045', '27" 4K Monitor',             1899.0000, 'ILS', 0.1600, 1, '2026-01-07 10:03:00.000000', '2026-01-07 10:03:00.000000'),
    (5,  'DCK-1102', '7290001000052', 'USB-C Docking Station',       749.5000, 'ILS', 0.1600, 1, '2026-01-07 10:04:00.000000', '2026-01-07 10:04:00.000000'),
    (6,  'PRN-4400', '7290001000069', 'Laser Printer A4',           1249.0000, 'ILS', 0.1600, 1, '2026-01-07 10:05:00.000000', '2026-01-07 10:05:00.000000'),
    (7,  'TNR-4401', '7290001000076', 'Toner Cartridge Black',       289.0000, 'ILS', 0.1600, 1, '2026-01-07 10:06:00.000000', '2026-01-07 10:06:00.000000'),
    (8,  'PPR-0500', '7290001000083', 'A4 Copy Paper (500 sheets)',   22.5000, 'ILS', 0.1600, 1, '2026-01-07 10:07:00.000000', '2026-01-07 10:07:00.000000'),
    (9,  'CHR-7700', '7290001000090', 'Ergonomic Office Chair',     1150.0000, 'ILS', 0.1600, 1, '2026-01-07 10:08:00.000000', '2026-01-07 10:08:00.000000'),
    (10, 'DSK-1400', '7290001000106', 'Standing Desk 140 cm',       2450.0000, 'ILS', 0.1600, 1, '2026-01-07 10:09:00.000000', '2026-01-07 10:09:00.000000'),
    (11, 'NET-2400', '7290001000113', 'Network Switch 24-Port',     1680.0000, 'ILS', 0.1600, 1, '2026-01-07 10:10:00.000000', '2026-01-07 10:10:00.000000'),
    (12, 'CBL-0603', '7290001000120', 'Cat6 Patch Cable 3 m',         18.0000, 'ILS', 0.1600, 1, '2026-01-07 10:11:00.000000', '2026-01-07 10:11:00.000000'),
    (13, 'LIC-0001', '7290001000137', 'Annual Software Licence',    1800.0000, 'ILS', 0.0000, 1, '2026-01-07 10:12:00.000000', '2026-01-07 10:12:00.000000'),
    (14, 'SVC-0010', '7290001000144', 'On-site Support Hour',        220.0000, 'ILS', 0.0000, 1, '2026-01-07 10:13:00.000000', '2026-01-07 10:13:00.000000'),
    (15, 'WRT-0024', '7290001000151', 'Extended Warranty 24 m',      640.0000, 'ILS', 0.0000, 1, '2026-01-07 10:14:00.000000', '2026-01-07 10:14:00.000000');

-- -------------------------------------------------------------------------------------
-- Sample invoices.
--
--   1  ILS  EXCLUSIVE  APPROVED    base currency, rate locked at 1
--   2  USD  INCLUSIVE  APPROVED    foreign currency, tax extracted from the price
--   3  JOD  EXCLUSIVE  DRAFT       three-decimal currency
...
--
-- Unit prices on foreign-currency invoices are the ILS catalogue price converted at the
...
VALUES
    (1, 'INV-2026-000001', 1, 'ILS', 1.000000, 'EXCLUSIVE', 'APPROVED', '2026-02-11', 'Q1 office refresh, delivered to the Ramallah branch.',
     9002.8000, 1440.4500, 10443.2500, 10443.2500,
     1, 1, '2026-02-12 09:14:22.000000', NULL, NULL, NULL, 0, '2026-02-11 08:00:00.000000', '2026-02-12 09:14:22.000000'),
    (2, 'INV-2026-000002', 2, 'USD', 3.650000, 'INCLUSIVE', 'APPROVED', '2026-03-19', 'Prices quoted tax inclusive at the customer''s request.',
     1876.5800, 300.2500, 2176.8300, 7945.4300,
     2, 1, '2026-03-20 11:02:47.000000', NULL, NULL, NULL, 0, '2026-03-19 08:00:00.000000', '2026-03-20 11:02:47.000000'),
    (3, 'INV-2026-000003', 3, 'JOD', 5.150000, 'EXCLUSIVE', 'DRAFT', '2026-05-04', 'Awaiting confirmation of the delivery window.',
     2291.2620, 366.6020, 2657.8640, 13688.0000,
     2, NULL, NULL, NULL, NULL, NULL, 0, '2026-05-04 08:00:00.000000', '2026-05-04 08:00:00.000000'),
    (4, 'INV-2026-000004', 4, 'EUR', 3.940000, 'INCLUSIVE', 'CANCELLED', '2026-06-22', 'Network refresh for the Nicosia distribution centre.',
     833.6600, 133.3900, 967.0500, 3810.1800,
    ...
    (5, 'INV-2026-000005', 5, 'GBP', 4.620000, 'EXCLUSIVE', 'DRAFT', '2026-08-01', 'Zero-rated services only.',
     2519.4900, 0.0000, 2519.4900, 11640.0400,
     2, NULL, NULL, NULL, NULL, NULL, 0, '2026-08-01 08:00:00.000000', '2026-08-01 08:00:00.000000'),
    (6, 'INV-2026-000006', 1, 'ILS', 1.000000, 'INCLUSIVE', 'CANCELLED', '2026-08-28', 'Replaced by a revised quotation.',
     2713.2700, 331.7300, 3045.0000, 3045.0000,
